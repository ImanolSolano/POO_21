...
public class Empleado extends Persona{
    ...
    public Empleado(int numeroEmpleado, String departamento, float sueldo, int horasExtras, Direccion domicilio, String nombre, String apParetno, String apMaterno, int edad, String curp) {
        super(nombre, apParetno, apMaterno, edad, curp);
        this.numeroEmpleado = numeroEmpleado;
        this.departamento = departamento;
        this.sueldo = sueldo;
        this.horasExtras = horasExtras;
